...
public class RadioControlService extends Service {
      ...
      public static final String RADIO_DATA = "com.example.bluetooth.le.RADIO_DATA";
      ...
      private final static String TAG = RadioControlService.class.getSimpleName();
      ...
      private final BroadcastReceiver mGattUpdateReceiver = new BroadcastReceiver() {
          ...
          public void onReceive(Context context, Intent intent) {
              ...
              } else if (SerialPortService.ACTION_DATA_WRITTEN_RADIO.equals(action)) {
                     Log.v(TAG, "Data sent to HW");

              } else if (SerialPortService.ACTION_DATA_AVAILABLE_RADIO.equals(action)) {
                  displayData(intent.getStringExtra(SerialPortService.RX_DATA));
                 // displayDataBat(intent.getStringExtra(SerialPortService.RADIO_BATTERY_DATA));
              }
          }
      };
      ...
      private void getFeatures() {
         ...
         // readGATTCharacteristic(charaPropBat, RadioBatData); - ignorar leitura da bateira,
         //                                                       só se consegure executar um readGATTCharacteristic de cada vez
      ...
      private void broadcastUpdate(final String action, final String data) {
          ...
          intent.putExtra(RADIO_DATA, data);
      ...
      private static IntentFilter makeGattUpdateIntentFilter() {
          ...
          intentFilter.addAction(SerialPortService.ACTION_DATA_WRITTEN_RADIO);
          return intentFilter;
      }
